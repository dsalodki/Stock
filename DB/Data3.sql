...
GO
INSERT [dbo].[PurchaseInvoices] ([Id], [BroughtId], [When], [ShippedId], [CheckedId], [IsOnStock]) VALUES (1, 3, CAST(N'2020-04-21T18:35:00.0000000' AS DateTime2), 2, 4, 1)
GO
...
GO
INSERT [dbo].[SalesInvoices] ([Id], [BroughtId], [When], [ShippedId], [CheckedId], [IsOutOfStock]) VALUES (1, 3, CAST(N'2020-04-22T16:03:00.0000000' AS DateTime2), 2, 4, 0)
GO
SET IDENTITY_INSERT [dbo].[SalesInvoices] OFF
GO
SET IDENTITY_INSERT [dbo].[Stocks] ON 
GO
INSERT [dbo].[Stocks] ([Id], [ProductId], [Count], [Cost], [Expiration], [State]) VALUES (1, 1, 50, CAST(100.00 AS Decimal(18, 2)), CAST(N'2020-04-23T00:00:00.0000000' AS DateTime2), 0)
GO
INSERT [dbo].[Stocks] ([Id], [ProductId], [Count], [Cost], [Expiration], [State]) VALUES (2, 2, 15, CAST(120.00 AS Decimal(18, 2)), CAST(N'2021-04-22T00:00:00.0000000' AS DateTime2), 0)
GO
INSERT [dbo].[Stocks] ([Id], [ProductId], [Count], [Cost], [Expiration], [State]) VALUES (3, 3, 60, CAST(50.00 AS Decimal(18, 2)), CAST(N'2020-05-22T00:00:00.0000000' AS DateTime2), 0)
GO
